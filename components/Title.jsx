const Title = () => {
  return (
    <div className="text-center my-8">
      ...
      <p className="mt-10 w-[740px] sm:w-auto m-auto text-xs sm:text-base">Stay updated with our latest insights, trends, and expert opinions across various topics. Discover engaging articles that inspire, inform, and keep you ahead!</p>
